...
public class OrderDaoImpl implements OrderDao {
    ...
    public List<OrdersInfo> ordersList(Orders orders) throws SQLException {
        ...
        return queryRunner.query(sql, new BeanListHandler<>(OrdersInfo.class), orders.getOstate());
    }
    ...
    public Boolean goodsstate(Orders orders) throws SQLException {
        String sql = "update orders set ostate=?, oupdatetime=? where oid=?";
        int update = queryRunner.update(sql, orders.getOstate(), OrderUtil.getNowTime(), orders.getOid());
        return update != 0;
    }
